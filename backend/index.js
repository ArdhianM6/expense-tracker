...
// Ambil semua transaksi (bisa filter tanggal & kategori)
...
// Ringkasan (total income, expense, balance per bulan)
...
app.put('/auth/profile', authenticate, async (req, res) => {
  ...
  try {
    ...
    // Kalau mau ganti password, verifikasi password lama dulu
    if (newPassword) {
...
// Ringkasan per bulan dalam 1 tahun
app.get('/transactions/annual', authenticate, async (req, res) => {
  ...
  try {
    ...
    // Lengkapi 12 bulan meskipun ada bulan yang kosong
